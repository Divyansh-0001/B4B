    ...
    <main className="relative">
      ...
      <section className="pb-24">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-slate/60 p-8 shadow-2xl backdrop-blur">
            <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(69,243,255,0.16),transparent_55%)] opacity-20" />
          ...
          <div className="rounded-3xl border border-white/10 bg-slate/60 p-8 text-sm text-slate-300 shadow-2xl backdrop-blur">
